...
function gg(){
    ...
    d.value=bc;
    if (value==bc){}
    else if(value==1 && bc==2){user=user+1;}
    else if(value==1 && bc==3){comp=comp+1;}
...
function ff(){
    ...
    d.value=bc;
    if (value==bc){}
    else if(value==2 && bc==3){user=user+1;}
    else if(value==2 && bc==1){comp=comp+1;}
    console.log(user,comp);
    e.value="User--> "+user+" Comp--> "+comp;
    if (user>comp){
        f.value="You are leading the game";
...
function ll(){
    ...
    d.value=bc;
    if (value==bc){}
    else if(value==3 && bc==1){user=user+1;}
    else if(value==3 && bc==2){comp=comp+1;}
    console.log(user,comp);
    e.value="User--> "+user+" Comp--> "+comp;
    if (user>comp){
        f.value="You are leading the game";
